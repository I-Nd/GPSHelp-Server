...
import com.example.study.dataobject.build.WorkerSqlBuild;
...
public interface WorkerMapper {
    ...
    @SelectProvider(type= WorkerSqlBuild.class,method = "buildQueryWorker")
    String queryByTaskId(Long task_id);
    /**
